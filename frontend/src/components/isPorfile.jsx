...
const IsProfile = ({ userData }) => {
  ...
  return (
    <>
      <h1 className=" font-bold text-3xl sm:text-5xl text-center py-10 pt-16">
        Your profile
      </h1>
      <form
      ...
      >
        <input
          ...
          className=" p-2 rounded-lg w-full outline-none border"
        />
        <input
          onChange={handleChange}
        ...
        {userData.role === "partner" && userData.modified === true && (
          <>
            ...
            <input
              onChange={handleChange}
              defaultValue={userData.storeCity}
              type="text"
              name="storeCity"
      ...
      {updated && (
        <div className=" bg-white p-3 text-green-500 fixed top-28 z-10 right-5 rounded-lg shadow-md border">
